...
(function () {
    ...
    var getParentalPropName = function getParentalPropName(chain, prop) {
    ...
    var dependencies = /*#__PURE__*/Object.freeze({
        ...
        getParentalPropName: getParentalPropName,
    ...
    function abortCurrentInlineScript(source, property) {
      ...
      var abort = function abort() {
        ...
        var content = scriptEl.textContent; // textContent of current script can be redefined
      ...
      var setChainPropAccess = function setChainPropAccess(owner, property) {
        ...
        var prop = chainInfo.prop,
            chain = chainInfo.chain;
        var baseName = getParentalPropName(property, prop); // The scriptlet might be executed before the chain property has been created
    ...
    abortCurrentInlineScript.injections = [randomId, setPropertyAccess, getPropertyInChain, toRegExp, getParentalPropName, createOnErrorHandler, hit];
