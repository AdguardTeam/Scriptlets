...
var getRedirectResourcesFromRule = function getRedirectResourcesFromRule(rule) {
    ...
    try {
        var ruleNode = ruleHelpers.getRuleNode(rule);
        if (ruleNode.category !== agtree.RuleCategory.Network) {
            return result;
        }
        if (ruleNode.type !== agtree.NetworkRuleType.NetworkRule) {
            return result;
        }
...
var isValidAdgRedirectRule = function isValidAdgRedirectRule(rule) {
    ...
    return agtree.modifiersCompatibilityTable.exists(resource.modifier, agtree.GenericPlatform.AdgAny) && isRedirectResourceCompatibleWithAdg(resource.resource);
};
...
exports.isValidAdgRedirectRule = isValidAdgRedirectRule;
