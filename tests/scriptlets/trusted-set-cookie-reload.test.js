...
const name = 'trusted-set-cookie-reload';
...
test('Set cookie string', (assert) => {
    let cName = '__test-cookie-reload_OK';
    let cValue = 'OK';
...
test('Set cookie with current time value', (assert) => {
    const cName = '__test-cookie-reload_OK';
    const cValue = '$now$';
...
test('Set cookie with expires', (assert) => {
    const cName = '__test-cookie-reload_expires';
...
test('Set cookie with negative expires', (assert) => {
    const cName = '__test-cookie-reload_expires_negative';
    const cValue = 'expires';
    const expiresSec = -2;
...
test('Set cookie with invalid expires', (assert) => {
    const cName = '__test-cookie-reload_expires_invalid';
    const cValue = 'expires';
