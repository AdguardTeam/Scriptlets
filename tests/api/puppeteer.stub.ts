 ...
 *
 * NOTE: this must be a separate file from `node-qunit-puppeteer.stub.ts` —
 * Vitest keys its mock registry by resolved path, so aliasing both module ids
 * to one file would make their `vi.mock` factories collide.
 */
export default {};
